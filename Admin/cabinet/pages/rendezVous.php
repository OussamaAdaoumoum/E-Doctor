                            ...
                            <table class="table table - bordred " id="mytable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?php echo explode(" ",$rend["start_event"])[0]?> </td>
                                        <td> <?php echo explode(" ",$rend["start_event"])[1]?> </td>
                                        <td> <?php echo explode(" ",$rend["end_event"])[1]?> </td>

                                        <td class="d-flex align-items-center">
                   

                                            <i class="far fa-trash-alt delete"
                                                onclick="supprimer_rend(<?php echo $rend ['id'] ?>)"> </i> <?php } ?>
                                        </td>
